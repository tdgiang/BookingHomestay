...
export default async function DashboardPage() {
  ...
  const [kpis, revenue, tasks] = await Promise.all([
    ...
    dashboardApi.revenue(token).catch(() => [] as import('@/lib/dashboard').RevenuePoint[]),
    dashboardApi.tasks(token).catch(() => [] as import('@/lib/dashboard').PendingTask[]),
  ]);
